...
document.getElementById("settings-refresh-btn").addEventListener("click", function() {
	...
	refreshIcon.classList.add("rotated");
	refreshIcon.addEventListener("transitionend", function() {
	  refreshIcon.classList.remove("rotated");
	}, { once: true });
  });
